...
const serviceAccount = require("./mobile-care-firebase-adminsdk.json");
...
async function run() {
  try {
    ...
    app.get("/services/mobile", async (req, res) => {
    ...
    app.get("/orders", verifyToken, async (req, res) => {
      ...
      if (requester) {
        ...
        res
          .status(403)
          .json({ message: "You do not have access to all orders." });
      }
    });
